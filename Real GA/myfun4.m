...
HF = -0.033635409 + 4.207557011*TF - 6.200339e-4*TF^2 + 4.459374e-6*TF^3 - 1e-3*xF*(-2.348e4 + 3.152e5*xF + 2.308e6*xF^2 - 1.446e7*xF^3 + 7.826e3*TF - 4.417e1*TF^2 + 2.139e-1*TF^3 - 1.991e4*xF*TF + 2.778e4*xF^2*TF + 9.728e1*xF*TF^2);
...
x0 = [1 1 2500 100 5 2 2 2000 2000 10 0.02 2000 80];
x0d = diag(x0);
x = x * x0d;
