...
x0 = [1 1 2500 100 5 2 2 2000 2000 10 20 2000 80 40 1500]';

F = [x0(1)*x(1) + x0(2)*x(2) - x0(6)*x(6);
    ...
    x0(12)*x(12) + 0.033635409 - 4.207557011*x0(13)*x(13) + 6.200339e-4*(x0(13)*x(13))^2 - 4.459374e-6*(x0(13)*x(13))^3 + (x0(11)*x(11))*(-2.348e10 + 3.152e5*x0(11)*x(11) + 2.308e6*(x0(11)*x(11))^2 - 1.446e7*(x0(11)*x(11))^3 + 7.826e3*x0(13)*x(13) - 4.417e1*(x0(13)*x(13))^2 + 2.139e-1*(x0(13)*x(13))^3 - 1.991e4*(x0(11)*x(11)*x0(13)*x(13)) + 2.778e4*(x0(11)*x(11))^2*x0(13)*x(13) + 9.728e1*x0(11)*x(11)*(x0(13)*x(13))^2);
    dT * (log(TV0 - x0(4)*x(4)) - log(TD1 - x0(14)*x(14))) - (TV0 - x0(4)*x(4) - TD1 + x0(14)*x(14));
    x0(15)*x(15) + 0.033635409 - 4.207557011*x0(14)*x(14) + 6.200339e-4*(x0(14)*x(14))^2 - 4.459374e-6*(x0(14)*x(14))^3 + xF*(-2.348e10 + 3.152e5*xF + 2.308e6*xF^2 - 1.446e7*xF^3 + 7.826e3*x0(14)*x(14) - 4.417e1 * (x0(14)*x(14))^2 + 2.139e-1*(x0(14)*x(14))^3 - 1.991e4*xF*x0(14)*x(14) + 2.778e4*xF^2*x0(14)*x(14) + 9.728e1*xF*(x0(14)*x(14))^2);
